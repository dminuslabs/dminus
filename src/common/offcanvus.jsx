import { X, MessageCircle, Camera, Globe, Palette } from 'lucide-react';
            ...
            <div className="tpoffcanvas-area">
                <div className={`tpoffcanvas ${sidebarOpen && "opened"}`}>
                    ...
                    <Link href="/" onClick={() => setSidebarOpen(false)}>
                        <Image src={logo} alt="Troth Communication" />
                    </Link>
                    </div>
                    ...
                    <Link href="#"><Image src={canvus_img_1}  alt="Troth Communication" /></Link>
                    <Link href="#"><Image src={canvus_img_2}  alt="Troth Communication" /></Link>
                    <Link href="#"><Image src={canvus_img_3}  alt="Troth Communication" /></Link>
                    <Link href="#"><Image src={canvus_img_4}  alt="Troth Communication" /></Link>
                    </div>
                    ...
                    <div className="social-icon text-center">
                        <Link href="#"><MessageCircle size={18} /></Link>
                        <Link href="#"><Camera size={18} /></Link>
                        <Link href="#"><Globe size={18} /></Link>
                        <Link href="#"><Palette size={18} /></Link>
                    </div>
                    </div>
                </div>
            </div>
